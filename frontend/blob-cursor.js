...
// fights the follow position or causes jitter.
(function(){
  ...
  const FOLLOW_RATE = 12;          // exponential smoothing rate (1/s) — higher = tighter follow
  ...
  function render(now) {
    ...
    // Frame-rate independent exponential smoothing — the blob glides
    // smoothly and consistently no matter the display's refresh rate.
